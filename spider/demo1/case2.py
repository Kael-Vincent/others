...
def mem_info():
    child = ssh_command("root", "10.9.26.34", "123123", "cat /proc/meminfo")
...
def vm_stat_info():
    child = ssh_command("root","10.9.26.34","123123", "vmstat 1 2 | tail -n 1")
    child.expect(pexpect.EOF)
...
def cpu_info():
    child = ssh_command("root", "10.9.26.34", "123123", "cat /proc/cpuinfo")
    child.expect(pexpect.EOF)
...
def load_stat():
    child = ssh_command("root","10.9.26.34","123123", "cat /proc/loadavg")
    child.expect(pexpect.EOF)
...
def ionetwork():
    child = ssh_command("root","10.9.26.34","123123", "cat /proc/net/dev")
    child.expect(pexpect.EOF)
...
def disk_stat():
    child = ssh_command("root","10.9.26.34","123123", "df -h")
    child.expect(pexpect.EOF)
    disk = child.before
...
def getComStr():
    child = ssh_command("root", "10.9.26.34", "123123", "netstat -tpln")
    child.expect(pexpect.EOF)
    Com = child.before
    print('******************************端口监控*********************************')
    print("*******************时间：", time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()), "******************")
...
def cpu():
    child = ssh_command("root","10.9.26.34","123123",'cat /proc/stat | grep "cpu "')
    child.expect(pexpect.EOF)
    child1 = ssh_command("root","10.9.26.34","123123", 'cat /proc/stat | grep "cpu "')
